...
public class auto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            while (sensorRange3.getDistance(DistanceUnit.INCH)<12) {
                double power = 0.3;
            ...
            while (sensorRange2.getDistance(DistanceUnit.INCH)<55){
                double power = 0.4;
                telemetry.addData("angle", getAngle());
                telemetry.update();
                if (getAngle() < -1){ //turn left
            ...
            while (sensorRange3.getDistance(DistanceUnit.INCH)<48) {
                double power = 0.3;
                telemetry.addData("angle", getAngle());
                telemetry.update();
                if (getAngle() < -1){ //turn left
